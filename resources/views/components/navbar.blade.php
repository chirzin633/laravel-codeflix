<nav class="fixed-top bg-body-nav navbar navbar-expand-lg">
            ...
            <ul class="d-flex pt-3 nav-icon">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu user-info">
                        <li>
                            <a class="dropdown-item user-info-item" href="#"
                                ><i class="fa-solid fa-circle-user"></i> Profile Setting</a
                            >
                        </li>
                        <li>
