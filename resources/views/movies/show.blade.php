...
@section ('content')
    ...
    <div class="container-movie">
        <div class="text-center row">
            ...
            <div class="text-md-start col-md-5">
        ...
        <div class="d-flex align-items-center justify-content-between mb-3 badge-frame-video">
            <div class="">
                ...
                <span class="ml-4 rounded-pill badge text badge-frame-video-tools">
